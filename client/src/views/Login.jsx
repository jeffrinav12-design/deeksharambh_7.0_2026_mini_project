  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center relative px-6 overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl p-8 relative z-10 border border-sky-100 shadow-xl">
        ...
        {/* Role Selection Tabs */}
        <div className="grid grid-cols-4 gap-1.5 mb-6 p-1.5 rounded-xl bg-sky-50 border border-sky-200">
          {['faculty', 'student', 'admin', 'viewer'].map((r) => (
            <button
              key={r}
              type="button"
              onClick={() => handleRoleChange(r)}
              className={`py-2 text-[11px] font-bold rounded-lg capitalize transition-all duration-150 cursor-pointer ${
                roleSelection === r 
        ...
        <div className="mb-5 space-y-2.5">
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl bg-white border border-slate-300 hover:border-slate-400 text-slate-700 font-bold text-xs transition-all duration-150 shadow-sm flex items-center justify-center gap-3 cursor-pointer hover:bg-slate-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-800 font-bold text-xs transition-all duration-150 shadow-sm flex items-center justify-center gap-3 cursor-pointer"
          >
            <svg className="w-4 h-4 flex-shrink-0 fill-current text-slate-800" viewBox="0 0 24 24">
          ...
          <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink mx-3 text-[10px] text-slate-400 font-semibold uppercase">Or Sign In With Email & Password</span>
            <div className="flex-grow border-t border-slate-200"></div>
          </div>
        </div>

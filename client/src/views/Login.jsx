      ...
      <div className="w-full max-w-md bg-white rounded-2xl p-8 relative z-10 border border-sky-100 shadow-xl">
        ...
        <div className="mb-5 space-y-2.5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl bg-purple-950 hover:bg-purple-900 border border-purple-700 text-white font-bold text-xs transition-all duration-150 shadow-md flex items-center justify-center gap-3 cursor-pointer"
          >
            <svg className="w-4 h-4 flex-shrink-0 fill-current text-purple-300" viewBox="0 0 24 24">
